...
/* */
global $main_sponsor;
$main_sponsor = array(	array(	country => "General",
						  		title => "ISA",
						...
						array(	country => "Austria",
								title1 => "GlobalScholar.us",
								url1 => "http://globalscholar.us",
								title2 => "AllAbroad.us",
								url2 => "http://allabroad.us"
							),
						array(	country => "Belgium",
								title1 => "ISA",
								url1 => "http://www.studiesabroad.com"
							),
						...
						array(	country => "China",
								title1 => "StudyAbroad.com",
								url1 => "http://www.studyabroad.com"
							),	
						array(	country => "Costa Rica",
								title1 => "ISA",
								url1 => "http://www.studiesabroad.com"
							),
						array(	country => "Czech Republic",
								title1 => "ISA",
								url1 => "http://www.studiesabroad.com"
							),
						array(	country => "Denmark",
								title1 => "Danish Institute for Abroad",
								url1 => "www.dis.dk/"
							),
						array(	country => "Egypt",
								title1 => "GlobalScholar.us",
						...
						array(	country => "France",
								title1 => "Institute for American Universities",
								url1 => "http://www.iaufrance.org/",
								title2 => "ISA",
								url2 => "http://www.studiesabroad.com",
								title3 => "StudyAbroad.com",
								url3 => "http://studyabroad.com"
							),
						array(	country => "Germany",
								title1 => "StudyAbroad.com",
								url1 => "http://studyabroad.com"
							),
						...
						array(	country => "Ireland",
								title1 => "CIEE",
								url1 => "http://www.ciee.org"
							),
						array(	country => "Italy",
								title1 => "ISA",
								url1 => "http://www.studiesabroad.com",
								title2 => "StudyAbroad.com",
								url2 => "http://studyabroad.com"
							),
						array(	country => "Japan",
								title1 => "StudyAbroad.com",
								url1 => "http://studyabroad.com"
						...
						array(	country => "United Kingdom",
								...
								url1 => "http://www.studiesabroad.com",
								title2 => "StudyAbroad.com",
								url2 => "http://www.studyabroad.com"
							),
						array(	country => "United States",
								title1 => "uStudy.us",
								url1 => "http://uStudy.us",
								title2 => "PLUS",
								url2 => "http://www.globaled.us/PLUS/"
							)
				);

global $sub_sponsor;
$sub_sponsor = array(	array(	country => "General",
								title1 => "HTH WorldWide",
								url1 => "http://www.hthworldwide.com/",
								title2 => "International SOS",
								url2 => "http://www.internationalsos.com/en/",
								title3 => "ISIC",
								url3 => "http://www.myisic.com",
								title4 => "STA Travel",
								url4 => "http://www.statravel.com/",
								title5 => "CIEE",
								url5 => "http://www.ciee.org/"
							),
						array(	country => "Australia",
								title1 => "HTH WorldWide",
								url1 => "http://www.hthworldwide.com/",
