<?php
	...
	$pageTitle = "Housing Arrangements";
	/* 
	...
	try {
		...
		if ($country_name == "United States") {
			$housingList  = new Template("content/handbook/practical-information/us-housing-content.tpl");
		} else {
			$housingList  = new Template("content/handbook/practical-information/housing-content.tpl");
		}
		
		
		
		if ($country_name == "United States" || $country_name == "United Kingdom" || $country_name == "Czech Republic" || $country_name == "Dominican Republic") {
			$housingList->set("country", "the ".$country['country_name']);
        }
		else {
			$housingList->set("country", $country['country_name']);
		}
		
		$housingList->set("nationality1", $country['nationality']);
		...
		*/
		...
		$layout->set("content", $housingList->output());
