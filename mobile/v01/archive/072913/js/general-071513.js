...
function getResults(formName, resultsType) {
	...
	//alert ("4 vars "+str_full_name+str_birth+str_citizenship+str_program_name);
	...
	//alert ("4 vars "+str_abroad_program_address+str_abroad_program_tel+str_abroad_program_mobile+str_abroad_program_email);
	...
	//alert ("4 vars "+str_abroad_housing_address +str_abroad_housing_tel+str_abroad_housing_mobile+str_abroad_housing_email);
	...
	//alert ("4 vars "+str_home_campus_address +str_home_campus_tel+str_home_campus_mobile+str_home_campus_email);
	...
	//alert ("4 vars "+str_family_address +str_family_tel+str_family_mobile+str_family_email);
	...
	//alert ("3 vars "+str_insurance_company +str_policy_number+str_emergency_phone);
	...
	//alert ("2 vars "+str_embassy_consulate_address +str_embassy_consulate_tel);
	
	var str_equivalent_911_abroad = document.forms[formName]["equivalent_911_abroad"].value;
	
	//alert ("1 vars "+str_equivalent_911_abroad);
	...
	//alert ("4 vars "+str_passport_number+str_blood_type+str_medical_conditions+str_wishes);
	...
	//alert ("2 vars "+str_nearest_hospital_abroad_address+str_nearest_hospital_abroad_tel);
	
	var str_special_code = document.forms[formName]["special_code"].value;
	//alert ("1 vars "+str_special_code);
	
	var parameters="full_name="+str_full_name+"&birth="+str_birth+"&citizenship="+str_citizenship+"&program_name="+str_program_name+"&abroad_program_contact="+str_abroad_program_contact+"&abroad_program_address="+str_abroad_program_address+"&abroad_program_tel="+str_abroad_program_tel+"&abroad_program_mobile="+str_abroad_program_mobile+"&abroad_program_email="+str_abroad_program_email+"&abroad_housing_contact="+str_abroad_housing_contact+"&abroad_housing_address="+str_abroad_housing_address+"&abroad_housing_tel="+str_abroad_housing_tel+"&abroad_housing_mobile="+str_abroad_housing_mobile+"&abroad_housing_email="+str_abroad_housing_email+"&home_campus_contact="+str_home_campus_contact+"&home_campus_address="+str_home_campus_address+"&home_campus_tel="+str_home_campus_tel+"&home_campus_mobile="+str_home_campus_mobile+"&home_campus_email="+str_home_campus_email+"&family_contact="+str_family_contact+"&family_address="+str_family_address+"&family_tel="+str_family_tel+"&family_mobile="+str_family_mobile+"&family_email="+str_family_email+"&insurance_company="+str_insurance_company+"&policy_number="+str_policy_number+"&emergency_phone="+str_emergency_phone+"&embassy_consulate="+str_embassy_consulate+"&embassy_consulate="+str_embassy_consulate+"&embassy_consulate_address="+str_embassy_consulate_address+"&embassy_consulate_tel="+str_embassy_consulate_tel+"&equivalent_911_abroad="+str_equivalent_911_abroad+"&nearest_hospital_abroad_address="+str_nearest_hospital_abroad_address+"&nearest_hospital_abroad_tel="+str_nearest_hospital_abroad_tel+"&passport_number="+str_passport_number+"&blood_type="+str_blood_type+"&medical_conditions="+str_medical_conditions+"&wishes="+str_wishes+"&special_code="+str_special_code;
...
function getResults2(formName, resultsType) {
	...
	var parameters="full_name="+str_full_name+"&birth="+str_birth+"&citizenship="+str_citizenship+"&program_name="+str_program_name+"&abroad_program_contact="+str_abroad_program_contact+"&abroad_program_address="+str_abroad_program_address+"&abroad_program_tel="+str_abroad_program_tel+"&abroad_program_mobile="+str_abroad_program_mobile+"&abroad_program_email="+str_abroad_program_email+"&abroad_housing_contact="+str_abroad_housing_contact+"&abroad_housing_address="+str_abroad_housing_address+"&abroad_housing_tel="+str_abroad_housing_tel+"&abroad_housing_mobile="+str_abroad_housing_mobile+"&abroad_housing_email="+str_abroad_housing_email+"&home_campus_contact="+str_home_campus_contact+"&home_campus_address="+str_home_campus_address+"&home_campus_tel="+str_home_campus_tel+"&home_campus_mobile="+str_home_campus_mobile+"&home_campus_email="+str_home_campus_email+"&family_contact="+str_family_contact+"&family_address="+str_family_address+"&family_tel="+str_family_tel+"&family_mobile="+str_family_mobile+"&family_email="+str_family_email+"&insurance_company="+str_insurance_company+"&policy_number="+str_policy_number+"&emergency_phone="+str_emergency_phone+"&embassy_consulate="+str_embassy_consulate+"&embassy_consulate="+str_embassy_consulate+"&embassy_consulate_address="+str_embassy_consulate_address+"&embassy_consulate_tel="+str_embassy_consulate_tel+"&equivalent_911_abroad="+str_equivalent_911_abroad+"&nearest_hospital_abroad_address="+str_nearest_hospital_abroad_address+"&nearest_hospital_abroad_tel="+str_nearest_hospital_abroad_tel+"&passport_number="+str_passport_number+"&blood_type="+str_blood_type+"&medical_conditions="+str_medical_conditions+"&personal_email="+str_personal_email+"&wishes="+str_wishes+"&special_code="+str_special_code;
