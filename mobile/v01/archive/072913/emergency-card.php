...
?>
                            ...
                            <div class="emergency-card-form">
                                <form id="myEmergencyCardForm" name="myEmergencyCardForm" method="post" <?php echo $action; ?> >
                                    <div>
                                        <h2>Student Information</h2>
                                        <label for="full_name">Student Name*</label>
                                        <input type="text" id="full_name" name="full_name" <?php if (isset($full_name)) { echo 'value="'.$full_name.'"'; } ?> placeholder="Your full name" maxlength="40" />
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="wishes_tel" name="wishes_tel" <?php if (!empty($wishes_tel)) { echo 'value="'.$wishes_tel.'"'; } ?> placeholder="Primary contact phone"  maxlength="40" />
                                        <?php if ($wishes_tel_error != "") { echo '<div>'.$wishes_tel_error.'</div>'; } ?>
                                        <label for="wishes_mobile">Mobile</label>
                                        <input type="text" id="wishes_mobile" name="wishes_mobile" <?php if (!empty($wishes_mobile)) { echo 'value="'.$wishes_mobile.'"'; } ?> placeholder="Primary contact mobile"  maxlength="40" />
                                        <?php if ($wishes_mobile_error != "") { echo '<div>'.$wishes_mobile_error.'</div>'; } ?>
                                        <label for="wishes_email">Email</label>
                                        <input type="text" id="wishes_email" name="wishes_email" <?php if (!empty($wishes_email)) { echo 'value="'.$wishes_email.'"'; } ?> placeholder="Primary contact email"  maxlength="40" />
                                    ...
                                    <div>
                                        ...
                                        <input type="text" id="family_contact" name="family_contact" <?php if (!empty($family_contact)) { echo 'value="'.$family_contact.'"'; } ?> placeholder="Secondary contact"  maxlength="40" />
                                        ...
                                        <input type="tel" id="family_tel" name="family_tel" <?php if (!empty($family_tel)) { echo 'value="'.$family_tel.'"'; } ?> placeholder="Secondary contact phone"  maxlength="40" />
                                        <?php if ($family_tel_error != "") { echo '<div>'.$family_tel_error.'</div>'; } ?>
                                        <label for="family_mobile">Mobile</label>
                                        <input type="tel" id="family_mobile" name="family_mobile" <?php if (!empty($family_mobile)) { echo 'value="'.$family_mobile.'"'; } ?> placeholder="Secondary contact mobile"  maxlength="40" />
                                        <?php if ($family_mobile_error != "") { echo '<div>'.$family_mobile_error.'</div>'; } ?>
                                        <label for="family_email">Email</label>
                                        <input type="email" id="family_email" name="family_email" <?php if (!empty($family_email)) { echo 'value="'.$family_email.'"'; } ?> placeholder="Secondary contact email"  maxlength="40" />
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" id="emergency_phone" name="emergency_phone" <?php if (!empty($emergency_phone)) { echo 'value="'.$emergency_phone.'"'; } ?> placeholder="24 hour emergency phone"  maxlength="40" />
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" id="abroad_program_tel" name="abroad_program_tel" <?php if (!empty($abroad_program_tel)) { echo 'value="'.$abroad_program_tel.'"'; } ?> placeholder="Abroad program phone"  maxlength="40" />
                                        <?php if ($abroad_program_tel_error != "") { echo '<div>'.$abroad_program_tel_error.'</div>'; } ?>
                                        <label for="abroad_program_mobile">Mobile</label>
                                        <input type="tel" id="abroad_program_mobile" name="abroad_program_mobile" <?php if (!empty($abroad_program_mobile)) { echo 'value="'.$abroad_program_mobile.'"'; } ?> placeholder="Abroad program mobile"  maxlength="40" />
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" id="home_campus_tel" name="home_campus_tel" <?php if (!empty($home_campus_tel)) { echo 'value="'.$home_campus_tel.'"'; } ?> placeholder="U.S. campus phone"  maxlength="40" />
                                        <?php if ($home_campus_tel_error != "") { echo '<div>'.$home_campus_tel_error.'</div>'; } ?>
                                        <label for="home_campus_mobile">Mobile</label>
                                        <input type="tel" id="home_campus_mobile" name="home_campus_mobile" <?php if (!empty($home_campus_mobile)) { echo 'value="'.$home_campus_mobile.'"'; } ?> placeholder="U.S. campus mobile"  maxlength="40" />
                                    ...
                                    <div>
                                        ...
                                        *
                                        <input type="tel" id="embassy_consulate_tel" name="embassy_consulate_tel" <?php if (!empty($embassy_consulate_tel)) { echo 'value="'.$embassy_consulate_tel.'"'; } ?> placeholder="Embassy/consulate phone"  maxlength="40" />
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" id="nearest_hospital_abroad_tel" name="nearest_hospital_abroad_tel" <?php if (!empty($nearest_hospital_abroad_tel)) { echo 'value="'.$nearest_hospital_abroad_tel.'"'; } ?> placeholder="Nearest hospital abroad phone"  maxlength="40" />
                                    </div>
                                    <div>
                                        <h2>Equivalent of 9&ndash;1&ndash;1 Emergency Abroad</h2>
                                        <label for="equivalent_911_abroad">Phone</label>
                                        <input type="tel" id="equivalent_911_abroad" name="equivalent_911_abroad" <?php if (!empty($equivalent_911_abroad)) { echo 'value="'.$equivalent_911_abroad.'"'; } ?> placeholder="Equivalent 9&ndash;1&ndash;1 abroad phone"  maxlength="40" />
                                    ...
                                    <div>
                                        ...
                                        <input type="tel" id="abroad_housing_tel" name="abroad_housing_tel" <?php if (!empty($abroad_housing_tel)) { echo 'value="'.$abroad_housing_tel.'"'; } ?> placeholder="Abroad housing phone"  maxlength="40" />
                                        <label for="abroad_housing_mobile">Mobile</label>
                                        <input type="tel" id="abroad_housing_mobile" name="abroad_housing_mobile" <?php if (!empty($abroad_housing_mobile)) { echo 'value="'.$abroad_housing_mobile.'"'; } ?> placeholder="Abroad housing mobile"  maxlength="40" />
