...
if ( isset($_POST['Submit']) ){
	...
	$confirm_personal_email = trim($_POST["confirm_personal_email"]);	
	...
	if (strlen($personal_email) < 0 || $personal_email == "") {
		if (!preg_match("/^[a-zA-Z0-9._-]+@[a-zA-Z0-9-]+\.[a-zA-Z.]+$/", $personal_email))
		{
			$personal_email_error = '<span class="error">Enter valid personal email</span>';
			$req_error .= $personal_error;
		}
	} 
	...
	if (strlen($confirm_personal_email) < 0 || $confirm_personal_email == "") {
		...
		{
			$confirm_personal_email_error = '<span class="error">Enter valid abroad program email</span>';
...
?>
                            <div class="form-step">
                            <?php 
								echo '<span>Step 2 of 3</span>';
							?>
                            	
                            </div>
                            <div class="form-instruction">
							<?php
								echo '<p>To ensure that your emergency card is complete, please read and review the information below.</p>';						
							?>
                                
                            </div>
                            <div class="emergency-card-form">
                                <form id="myEmergencyCardForm" name="myEmergencyCardForm" method="post" onsubmit="getResults('myEmergencyCardForm','orderCard')" >
                                    <div>
                                    ...
                                    <div class="send_information">
                                        ...
                                        <input type="email" id="personal_email" name="personal_email" placeholder="Your personal email"  maxlength="40" <?php if (!empty($personal_email)) { echo 'value="'.$personal_email.'"'; } ?> />
                                        <?php if ($personal_email_error != "") { echo '<div>'.$personal_email_error.'</div>'; } ?>
                                        <label for="confirm_personal_email">Confirm Email*</label>
                                        <input type="email" id="confirm_personal_email" name="confirm_personal_email" placeholder="Confirm your personal email" maxlength="40" equalTo="#personal_email" <?php if (!empty($confirm_personal_email)) { echo 'value="'.$confirm_personal_email.'"'; } ?> />
