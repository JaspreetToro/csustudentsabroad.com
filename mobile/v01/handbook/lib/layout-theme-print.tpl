...
<title>StudentsAbroad.com - Study Abroad Handbook [@country]: [@title]</title>
<link rel="icon" href="/favicon.png" type="image/png" />
<link type="text/css" href="/styles/print-studentabroad-styles.css" rel="stylesheet" />
<link rel="stylesheet" media="print" type="text/css" href="/styles/print-studentabroad-styles.css">
<script type="text/javascript" src="/javascript/general.js"></script>
<!--[if IE]><link type="text/css" href="/styles/ie.css" rel="stylesheet" /><![endif]-->
            ...
            <div id="top_header_container">
                <div class="student_handbook_header_container">
                	<div class="sh_header_left_container">
                        <div id="[@country_banner]_ps_container">
                        	<div class="student_handbook_title">Study Abroad Student Handbook</div>
                            <div class="country_name_sh"><img src="/handbook/images/country-flag/[@country]-flag.gif" class="[@flag_class]" alt="[@country]" width="47px" height="26px" />&nbsp;[@country]</div>
                        </div>
                    </div>
                    <div class="sh_header_middle_container"></div>
                    <div class="sh_header_right_container">
                    	<div class="sh_header_sponsor">[@lead_sponsors1]</div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="left_content_main_top">
                        <div id="glowingtab_handbook_container">
                            <div id="nav-bar" class="droplinebar">
                                <ul>
                                    <li>
                                        <a href="introduction.php?country=[@country_link]">Introduction<br />
                                        &nbsp; </a>
                                        <div>
                                            <div class="menu">
                                                <div class="menu_1cols">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="why-study-abroad.php?country=[@country_link]">Why Study <span>[@country_menu]</span></a>
                                                        </li>
                                                        <li>
                                                            <a href="why-learn-a-language.php?country=[@country_link]">Why Learn <span>[@language]</span></a>
                                                        </li>
                                                        <li>
                                    ...
                                    <li>
                                        <a href="begin-program-search.php?country=[@country_link]">Choosing A<br />
                                        Program</a>
                                        <div>
                                            <div class="menu">
                                                <div class="menu_1cols">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="begin-program-search.php?country=[@country_link]">Begin Program Search</a>
                                                        </li>
                                                        <li>
                                    ...
                                    <li>
                                        <a href="pre-departure-planning.php?country=[@country_link]">Practical<br />
                                        Information</a>
                                        <div>
                                            <div class="menu">
                                                <div class="menu_1cols">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="housing.php?country=[@country_link]">Housing Arrangements</a>
                                                        </li>
                                                        <li>
                                    ...
                                    <li>
                                        <a href="basic-health-and-safety.php?country=[@country_link]">Health &amp;<br />
                                        Safety</a>
                                        <div>
                                            <div class="menu">
                                                <div class="menu_1cols">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="medical-care-and-insurance.php?country=[@country_link]">Medical Care and Insurance</a>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <a href="adjustments-and-culture-shock.php?country=[@country_link]">Adjustments and Culture Shock</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <li>
                                        <a href="airport-procedures.php?country=[@country_link]">Coming<br />
                                        Home</a>
                                        <div>
                                            <div class="menu">
                                                <div class="menu_1cols">
                                    ...
                                    <li class="main_last">
                                        <a href="questions.php?country=[@country_link]">Tools For<br />
                                        Planning</a>
                                        <div>
                                            <div class="menu">
                                                <div class="menu_3cols">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="checklist.php?country=[@country_link]">Study Abroad Checklist</a>
                                                        </li>
                                                        <li>
                                                            <a href="resources.php?country=[@country_link]">Study Abroad Resources</a>
                                                        </li>
                                                        <li>
                                                        	<a href="top-10-health-and-safety-issues.php?country=[@country_link]">Top 10 Health and Safety Issues</a>
                                                        </li>
                                                ...
                                                <div class="menu_3cols">
                                                    ...
                                                    <ul>
                                                        <li>
                                                            <a href="communication-info-sheets.php?country=[@country_link]">Communication Info Sheets</a>
                                                        </li>
                                                        <li>
                ...
                <div id="right_content_middle_sm">
                    ...
                    <div id="sponsors">
                        ...
                        <div id="sponsors1_container">
                            <!--<div id="main_sponsors_featured1">[@main_sponsors]</div>-->
                            [@main_sponsors]
                        </div>
                        <!-- NOTE: if have more sponsor, insert here-->
						<div id="sponsors_bar"></div>
                        <div id="sponsors2" class="[@subsponsors_action]">
                    ...
                    <div id="study_abroad_resources">
                        <div id="student_handbook_title_container">
                            <div id="student_handbook_title">[@student_handbook_title] <!-- Study Abroad--> <br />Student Handbook</div>
                        </div>
