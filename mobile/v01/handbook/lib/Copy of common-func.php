<?php
	...
	function print_category_menu($category, $country_name, $language, $country_menu) {
		...
		if($category == 0) {
			$html = "<div class=\"row\">";
			$html = $html . "<h3>Understanding Study Abroad</h3>";
			$html = $html . "<ul>";
			...
			$html = "<div class=\"row\">";
			$html = $html . "<h3>Choosing a Program</h3>";
			$html = $html . "<ul>";
			...
			$html = "<div class=\"row\">";
			$html = $html . "<h3>Practical Information</h3>";
			$html = $html . "<ul>";
