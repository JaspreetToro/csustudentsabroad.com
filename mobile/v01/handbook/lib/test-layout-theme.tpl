                                            ...
                                            <div class="menu">
                                                <div class="menu_1cols">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="why-study-abroad.php?country=[@country_link]">Why Study in <span>[@country_menu]</span></a>
                                                        </li>
                                                        <li>
        ...
        <li class="menu">
            <ul>
                ...
                <li class="dropdown">
                    <ul>
                        <li>
                            <a href="/handbook/finding-quality-program.php?country=[@country_link]">Finding a Quality Program</a>
                        </li>
                        <li>
            ...
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/handbook/housing.php?country=[@country_link]">Housing</a>
                        </li>
                        <li>
        ...
        <li class="menu">
            <ul>
                ...
                <li class="dropdown">
                    ...
                    <ul>
                        <li>
                            <a href="/handbook/communication-info-sheets.php?country=[@country_link]">Communication Info Sheet</a>
                        </li>
                        <li>
