<?php
	...
	try {
		...
		$usersList  = new Template("content/handbook/introduction-overview-content.tpl");
		...
		elseif ($country_name == "General") {
			...
			$layout->set("category_menu", print_category_menu($category, $country_name, $country['primary_language'], "in ".$country['county_name']));
