<?php
    ...
    */
	...
	function cleanUpPhrase($phrase)
	{
		...
		// ignore stop words
		$words = removeStopWordsFromArray($words);
	...
	function getWords($body, $title)
	{
	  
	  
	  // body
	  $raw_text =  str_repeat(' '.strip_tags($body), 1);
	  ...
	  // title, tag and body stemming
	  $stemmed_words = stemPhrase($raw_text);
	...
	//print_r(getWords("Couldn't see, dark, blurry, dizzy, squinting did no good...", "see blurry", "dizzy, blurry"));
	
	//echo PorterStemmer::Stem("giving");
