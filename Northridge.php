    ...
    <span class="new_subpage_left_container">
        <div id="new_subpage_left_container_top">
            <div id="left_content_top_upper">
                        ...
                        <div id="left_content_top_upper2">CSU NORTHRIDGE
                        </div> 
                    </div>
        ...
        <!-- end of subpage_left_container_top  -->
                    ...
                    <div id="subpage_image" style="background:url(../images/northridge1.jpg);">
                    </div>
                    <!-- end of inage division-->
                    <div id="subpage_text2">
                        <p><div id="subpage_text_title"><a href="https://www.csun.edu/">About CSU Northridge</a></div> </br>  California State University, Northridge is a vibrant, diverse university community of 38,310 students and more than 4,000 faculty and staff, sited on a 356-acre campus in the heart of Los Angeles' San Fernando Valley. 
                    ...
                    <!-- end text2 divsion-->
                    <div id="subpage_image" style="background:url(../images/northridge2.jpg) ;">
                    </div>   
    </span>
