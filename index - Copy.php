...
<br />
    ...
    <!--    <div class="box_advanced"><a href="advancedsearch.php" class="small_dark_blue_bold">Advanced Search</a></div> -->
        <br />
        <div style="margin:-5px 0px -10px 0px"><a href="/advancedsearch.php">Advanced Search</a></div>
        <br />

        <div class="box_bottom_form" style="margin:-5px 0px -5px 0px"><a href="http://terradotta.com/"><img alt="Terradotta Logo" src="images/poweredbyterradotta.png" width="198" height="45" border="0"/></a></div>
            </div>
