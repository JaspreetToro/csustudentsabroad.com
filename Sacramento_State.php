    ...
    <span class="new_subpage_left_container">
        <div id="new_subpage_left_container_top">
            <div id="left_content_top_upper">
                        ...
                        <div id="left_content_top_upper2">SACRAMENTO STATE UNIVERSITY
                        </div> 
                    </div>
            <div id="new_nonav_subpage_content" >
                ...
                <div>
                    ...
                    <div class="subpage_full_text">
                        <div id="subpage_text_title"><a href="https://www.cce.csus.edu/faculty-led-study-abroad">Study Abroad Support</a></div></br>
                        <div id="subpage_text1"><p>Sacramento State believes international education plays an important role in the academic and personal growth of     students. The university is reviving and expanding the faculty-led short-term travel programs, making this more accessible for students to  study abroad. These short-term, international experiences designed for students who cannot spend an entire year abroad, infuses international, intercultural, and global dimensions into their academic experience.  For example, The Division of Criminal Justice planned an exciting study and travel opportunity for Summer 2019 to explore the vibrant, peaceful, and culturally enriching nation of Ghana in West Africa. Students have the opportunity to participate in programs that meet their goals and gain valuable experience. During your travels, you will learn from Sacramento State faculty, as well as in-country guest lecturers at host universities. 
                        </div>
                        </p>
        ...
        <!-- end of subpage_left_container_top  -->
                    ...
                    <div id="subpage_image" style="background:url(../images/sacramento1.jpg);">
                    </div>
                    <!-- end of inage division-->
                    <div id="subpage_text2">
                        <p><div id="subpage_text_title"><a href="https://www.csus.edu/">About Sacramento State</a></div> </br>
                            <div>As California's capital university, CSU Sacramento transform lives by preparing students for leadership, service, and success. Sacramento State provides world-class, affordable education in the political, cultural, and economic heart of the Golden State. The university is a recognized leader in education, innovation, and engagement, dedicated to the belief that there are no limits to our students’ potential for excellence and success. 
                            </div>
                        </p>
                        
                    </div>
                    <!-- end text2 divsion-->
                    <div id="subpage_image" style="background:url(../images/sacramento2.jpg) ;">
                    </div>   
    </span>
