...
ContentSlider.buildpagination=function(sliderid){
	...
	{	
		...
		pcontent+='<div id="item'+i+'" onClick=\"ContentSlider.turnpage(\''+sliderid+'\', '+i+'); return false\" class="feature_link"><div style="height: 7px; font-size: 1px;"></div><a href="#" onClick=\"ContentSlider.turnpage(\''+sliderid+'\', '+i+'); return false\">'+(slider.paginateText? slider.paginateText[i] : i+1)+'</a></div>'
	}
