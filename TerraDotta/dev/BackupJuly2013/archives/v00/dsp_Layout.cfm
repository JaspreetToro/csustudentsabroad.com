    ...
    <div id="maincontainer_top">
        <div id="header">
            <div id="left_header">
                ...
                <div id="left_header_logo"><a href="http://studentsabroad.us"><img src="http://studentsabroad.us/images/studentsabroad-logo.jpg" alt="StudentsAbroad logo" /></a></div>
                    ...
                    <div id="glowingtabs">
                        <ul>
                            <li>
                                <div>
                                    <div>
                                        <div class="padding13"><a href="http://studentsabroad.us/index.php" title="Home: Welcome to StudenstAbroad.com" class="home_link">Home</a></div>
                                        <div class="menu_subtitle"><a href="http://studentsabroad.us/index.php" title="Home: Welcome to StudenstAbroad.com" class="home_link">The Main Page</a></div>
                                    </div>
                                </div>
                            </li>
                            <li id="current">
                            ...
                            <li>
                                <div>
                                    <div>
                                        <div class="padding13"><a href="http://studentsabroad.us/handbook/introduction.php?country=General" title="Student Handbooks: How to Get There and Back" class="apply_subnav_link">Student Handbooks</a></div>
                                        <div class="menu_subtitle"><a href="http://studentsabroad.us/handbook/introduction.php?country=General" title="Student Handbooks: How to Get There and Back" class="apply_subnav_link">How to Get There and Back</a></div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div>
                                    <div>
                                        <div class="padding13"><a href="http://studentsabroad.us/featured-programs.php" title="Featured Programs: Options Around the World" class="finance_subnav_link">Featured Programs</a></div>
                                        <div class="menu_subtitle"><a href="http://studentsabroad.us/featured-programs.php" title="Featured Programs: Options Around the World" class="finance_subnav_link">Options Around the World</a></div>
                                    </div>
                                </div>
                            </li>
                        </ul>
                    ...
                    <div id="community_tab">
                        <div id="glowingtabs_orange">
                            <ul>
                                <li>
                                    <div>
                                        <div class="padding13"><a href="http://studentsabroad.us/about_us.php" title="About Us">About Us</a></div>
                                    </div>
                                </li>
                                <li>
                                    <div>
                                        <div class="padding13"><a href="http://studentsabroad.us/contact_us.php" title="Contact Us">Contact Us</a></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div id="footerTD">
                                    ...
                                    <div id="footerBottomTD">
                                        <cfif isDefined("LAYOUT_VARS.SSTOCKLAYOUTFOOTERIMAGE") and len(trim(LAYOUT_VARS.SSTOCKLAYOUTFOOTERIMAGE))>
                                            <div align="#LAYOUT_VARS.SSTOCKLAYOUTFOOTERORENTATION#"><a href="#LAYOUT_VARS.SPUBHOSTRELATIVEROOT#index.cfm?FuseAction=Abroad.Home" title="#LAYOUT_VARS.SACCOUNTNAME# - #LAYOUT_VARS.SACCOUNTINSTITUTION#"><img border="0" src="#LAYOUT_VARS.SPUBHOSTRELATIVEROOT#accounts/#sa_instance#/themes/stockassets/#LAYOUT_VARS.SSTOCKLAYOUTFOOTERIMAGE#" alt="#LAYOUT_VARS.SACCOUNTNAME# - #LAYOUT_VARS.SACCOUNTINSTITUTION#" /></a></div>
                                            <cfelse>
                                ...
                                <div id="main_sponsors_featured">
                                    <cfif IsDefined("url.pc") or isDefined("url.pi")>
                                        ...
                                        <cfif myPcVar eq "Argentina" or myPiVar eq "BuenosAires" or myPiVar eq "Cairns" or myPiVar eq "Mendoza">
                                            ...
                                            <img src="http://studentsabroad.us/images/logo/default-logo.jpg" alt="Default logo" />
                                            <cfelseif myPcVar eq "Australia" or myPiVar eq "Adelaide" or myPiVar eq "Brisbane" or myPiVar eq "GoldCoast" or myPiVar eq "Hobart" or myPiVar eq "Lismore" or myPiVar eq "Melbourne" or myPiVar eq "NorthRyde" or myPiVar eq "Perth" or myPiVar eq "Sydney" or myPiVar eq "Wollongong">
                                            ...
                                            <cfelseif myPcVar eq "Belgium" or myPiVar eq "Brussels" or myPiVar eq "Fora">
                                            <a href="http://www.iaufrance.org/" title="Institute for American Universities" target="_blank"><img src="http://studentsabroad.us/images/logo/Institute-for-American-Universities-logo.jpg" alt="Intitute for American Universities logo" /></a>
                                            <cfelseif myPcVar eq "Brazil" or myPiVar eq "Brasilia" or myPiVar eq "RiodeJaneiro" or myPiVar eq "SaoPaulo">
                                            <img src="http://studentsabroad.us/images/logo/default-logo.jpg" alt="Default logo" />
                                            <!--<img src="http://studentsabroad.us/images/logo/GlobalScholar-logo.jpg" alt="GlobalScholar.us" />-->
                                            <a href="http://allabroad.us" alt="AllAbroad.us" title="AllAbroad.us" target="_blank"><img src="http://studentsabroad.us/images/logo/AllAbroad-logo.jpg" alt="AllAbroad.us"/></a>
                                            ...
                                            <a href="http://allabroad.us" alt="AllAbroad.us" title="AllAbroad.us" target="_blank"><img src="http://studentsabroad.us/images/logo/AllAbroad-logo.jpg" alt="AllAbroad.us"/></a>
                                            <cfelseif myPcVar eq "France" or myPiVar eq "Aix-en-Provence" or myPiVar eq "Nice" or myPiVar eq "France">
                                            <a href="http://www.iaufrance.org/" title="Institute for American Universities" target="_blank"><img src="http://studentsabroad.us/images/logo/Institute-for-American-Universities-logo.jpg" alt="Intitute for American Universities logo" /></a> <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.us/images/logo/StudyAbroad-logo.jpg" alt="StudyAbroad.com" /></a>
                                            <cfelseif myPcVar eq "Germany" or myPiVar eq "Berlin" or myPiVar eq "Bielefeld" or myPiVar eq "Hamburg" or myPiVar eq "Hannover" or myPiVar eq "Marburg">
                                            <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.us/images/logo/StudyAbroad-logo.jpg" alt="StudyAbroad.com" /></a>
                                            <cfelseif myPcVar eq "Ghana" or myPiVar eq "Accra">
                                        ...
                                        <cfelse>
                                        <a href="http://studiesabroad.com/" alt="International Studies Abroad" title="International Studies Abroad" target="_blank"><img src="http://studentsabroad.us/images/logo/International-Studies-Abroad-ISA-logo.jpg"/></a>
                                    </cfif>
                                    <!--</div>-->
                                </div>
                            </div>
                            ...
                            <div class="student_handbook_menu">
                                <ul class="student_handbook_container">
                                    ...
                                    <li class="menu">
                                        <ul>
                                            <li class="button">
                                                <a href="#" class="dropdown_button">Health and Security <span></span></a>
                                            </li>
                                            <li class="dropdown">
                                                <ul>
                                                    <li>
