<div>
    ...
    <cfelseif myPcVar eq "Canada" or arrayContains(caCityArray, myPiVar) eq "yes">
		<cfset line1 = [CONAHECsponsorLogo.gen] />
        <cfset line2 = [] />
        <cfset line3 = [] />
        <cfset line4 = [] />
        <cfset lineTotal = [line1] />  
    ...
    <cfelseif myPcVar eq "Denmark" or arrayContains(dkCityArray, myPiVar) eq "yes">
		<cfset line1 = [DIAsponsorLogo.gen] />
        <cfset line2 = [] />
        <cfset line3 = [] />
        <cfset line4 = [] />
        <cfset lineTotal = [line1] />  
    ...
    <cfelseif myPcVar eq "France" or arrayContains(frCityArray, myPiVar) eq "yes">
		<cfset line1 = [ISAsponsorLogo.fr] />
        <cfset line2 = [IAUsponsorLogo.gen] />
        <cfset line3 = [] />
        <cfset line4 = [] />
    ...
    <cfelseif myPcVar eq "Ireland" or arrayContains(ieCityArray, myPiVar) eq "yes">
        ...
        <cfset line2 = [CIEEsponsorLogo.ie] />
        <cfset line3 = [] />
        <cfset line4 = [] />
        <cfset lineTotal = [line1,line2] />  
        <cfset listingDisplay = "yes" />      
                                            ...
                                            <div id="listing#i#">
                                                <ul>
                                                    ...
                                                    <cfif sponsorswap eq "#j#">
                                                        <li><div class="listing_name"><a href="#lineTotal[i][j].url#" target="_blank">#lineTotal[i][j].title#</a>:</div> <div class="listing_desc">#lineTotal[i][j].listing_desc#</div></li>
                                                    </cfif>
                                                </ul>
                                            </div>
                                            <cfelse>
