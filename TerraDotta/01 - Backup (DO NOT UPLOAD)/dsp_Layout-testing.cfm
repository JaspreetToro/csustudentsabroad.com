...
<link type="text/css" href="http://studentsabroad.com/styles/test-styles.css" rel="stylesheet" />
...
<div class="TESTING" style="background-color:#FFF;color:#F00;">
<style type="text/css">
.pc {font: 14px "Arial Black", Gadget, sans-serif;} 
.warn {color:#00F;}
</style>
<cfset params = structKeyList(url) />
<div class="warn">...TEST DUMP...</div>
<!--<cfdump label="parameters" var="#params#" />-->
<cfloop index="ix" list="#params#">
    <cfoutput><div class="#ix#">#ix# = #url[ix]#</div></cfoutput>
</cfloop>
<cfif IsDefined("url.pc") or isDefined("url.pi")>
    <div class="warn">...COUNTING...</div>
    <cfset i = 0 />
    <cfloop index="ix" list="#url.pc#">
    	<cfif IsDefined("url.pc")>
        <cfoutput>#i+1# #ix# </cfoutput>
        <cfset i++ />
        <cfelse>
        <cfset i = 0 />
        </cfif>
...
<cfif IsDefined("url.pc") or isDefined("url.pi")>
<div class="warn">...TESTING...</div>
<cfif IsDefined("url.pc")>
<cfset urlpcL =ListLen(url.pc) />
<cfelse>
	<cfset urlpcL = 0 />
</cfif>
<cfoutput><div class="warn">Country Elements (pc) Count: #urlpcL#</div></cfoutput>
</cfif>
</div>
            ...
            <div id="top_header_container">
                <div class="student_handbook_header_container">
                        ...
                        <div>
                            ...
                            <cfif IsDefined("url.pc") or isDefined("url.pi")>
								...
								or myPiVar eq "Ramallah">
                                    <cfset myBannerVar="Palestinian-Territories" />
                                    <!-- new -->
                                ...
                                <cfset myBanner=Replace(myBannerVar,'-','_','All') />
                    ...
                    <div class="sh_header_right_container">
                        <div class="sh_header_sponsor"></div>
                    </div>
                </div>
            </div>
                ...
                <div id="left_content">
                    ...
                    <div class="left_content_middle">
                        ...
                        <div id="sponsors_banner_container">
                            <cfparam name="bannerswap" default="#randrange(1, 3)#">
                            <cfif bannerswap is "1">
                                <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/sponsors/banner-terradotta.jpg" width="652" height="98" alt="Terra Dotta" /></a>
                                <cfelseif bannerswap is "2">
                                <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/sponsors/banner-studyabroad.jpg" width="652" height="98" alt="Terra Dotta" /></a>
                                <cfelseif bannerswap is "3">
                                <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/sponsors/banner-IAU.jpg" width="652" height="98" alt="Terra Dotta" /></a>
                            </cfif>
                        </div>
                        <!-- ******************* -->
                    </div>
                                    ...
                                    <cfif IsDefined("url.pc") or isDefined("url.pi")>
                                        ...
                                        <cfif myPcVar eq "Argentina"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/argentina" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Australia"
                                            or myPiVar eq "Adelaide"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://www.globalinksabroad.org/" alt="GlobaLinksAbroad.com" title="GlobaLinksAbroad.com" target="_blank">GlobaLinks Learning Abroad</a>: Seeks to foster the development of future leaders who, through an intercultural learning opportunity, gain a greater respect for and understanding of the relationship which exists between North American and the rest of the world in the context of the larger global community.</li>
                                                    <li><a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank">StudyAbroad.com</a>: A study abroad program directory with study abroad information including summer study abroad programs, study abroad scholarship information, internship study abroad programs &amp; language study abroad courses.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Austria"
                                            or myPiVar eq "Braunau"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://GlobalScholar.us" alt="GlobalScholar.us" title="GlobalScholar.us" target="_blank">GlobalScholar.us</a>: The new Global Scholar Online Courses can help you get abroad and return to use your international learning to help you make a difference... for your education, your career and your future.</li>
                                                    <li> <a href="http://allabroad.us" alt="AllAbroad.us" title="AllAbroad.us" target="_blank">AllAbroad.us</a>: A resource for students, parents, faculty, and administrators interested in study abroad. In it, you will find answers to common questions about study abroad given by our experienced mentors, including study abroad administrators, counselors, former study abroad students, and parents. </li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Belgium"
                                            or myPiVar eq "Antwerp"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/belgium" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                </ul>
                                            </div>
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC" target="_blank">CONAHEC</a>: A non&ndash;profit membership organization which advises and connects higher education institutions interested in establishing or strengthening academic collaborative programs in the North American region.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Chile"
                                            or myPiVar eq "Antofagasta"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/chile" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "China"
                                            or myPiVar eq "Baotou"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/costa_rica" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "CzechRepublic" 
                                            or myPiVar eq "Brno" 
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/czech_republic" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Denmark" 
                                            or myPiVar eq "Aalborg" 
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://www.dis.dk/" alt="Danish Institute for Study Abroad" title="Danish Institute for Study Abroad" target="_blank">Danish Institute for Study Abroad</a>: Learn and experience Europe through forward-thinking academic study abroad programs and courses, integrated study tours across Europe, unique accommodation options and an extensive cultural immersion program.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "DominicanRepublic" 
                                            or myPiVar eq "Jarabacoa" 
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://www.iaufrance.org/" title="Institute for American Universities" target="_blank">Institute for American Universities</a>: Study Abroad Programs in French and English in the south of France</li>
                                                    <li><a href="http://studiesabroad.com/france" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                    <li><a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank">StudyAbroad.com</a>: A study abroad program directory with study abroad information including summer study abroad programs, study abroad scholarship information, internship study abroad programs &amp; language study abroad courses.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Germany"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://www.CIEE.org" alt="CIEE" title="CIEE">CIEE</a>: A leading provider of international educational experiences.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Italy"
                                            or myPiVar eq "Milan"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/italy" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Japan"
            								or myPiVar eq "Kyoto" or myPiVar eq "Tokyo"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/jordan" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "KenyaCoastRepublic"
                                            or myPcVar eq "Kenya Coast Republic"
                                            ...
                                            or myPiVar eq "Rabat" 
                                            or myPiVar eq "Tetouan">
                                            <a href="http://studiesabroad.com/morocco" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo.jpg" alt="ISA" /></a>
                                            <cfelseif myPcVar eq "Netherlands"
                                            or myPiVar eq "Amsterdam"
                                            or myPiVar eq "Delft"
                                            or myPiVar eq "DenHaag"
                                            ...
                                            or myPiVar eq "Ayacucho" 
                                            or myPiVar eq "Arequipa">
                                            <a href="http://studiesabroad.com/peru" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo.jpg" alt="ISA" /></a>
                                            <cfelseif myPcVar eq "Poland" 
                                            or myPiVar eq "Krakow" 
                                            or myPiVar eq "Poznan"
                                            or myPiVar eq "Warsaw"
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/<cfoutput>#myPcVar#</cfoutput>" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Sweden"
                                            or myPiVar eq "Alnarp" 
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://studiesabroad.com/england" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                    <li><a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank">StudyAbroad.com</a>: A study abroad program directory with study abroad information including summer study abroad programs, study abroad scholarship information, internship study abroad programs &amp; language study abroad courses.</li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "UnitedStates" 
                                            ...
                                            <div class="program_sponsors_list">
                                                <ul>
                                                    <li><a href="http://uStudy.us/" alt="uStudy.us" title="uStudy.us" target="_blank">uStudy.us</a>: Introduces international students to the benefits and challenges to studying in the U.S. through courses of consisting of cultural differences & adjustment, universities, mentorship, communication, language, health, safety, visas, and employment information. </li>
                                                    <li><a href="http://globaled.us/PLUS/" alt="PLUS: The Project for Learning in the United States" title="PLUS: The Project for Learning in the United States" target="_blank">The Project for Learning in the United States (PLUS)</a>: The Project For Learning In The United States (PLUS) is an integrated international student preparation, training, and support program. </li>
                                                </ul>
                                            </div>
                                            <cfelseif myPcVar eq "Vietnam"
                                            or myPiVar eq "AnGiang"
                                            ...
                                            <cfelse>
                                            <div class="program_sponsors_list">
                                                <cfparam name="sponsorswap" default="#randrange(1, 3)#">
                                                <div class="listing1">
                                                    <ul>
                                                        <cfif sponsorswap is "1">
                                                            <li><a href="http://studiesabroad.com/jordan" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                            <cfelseif sponsorswap is "2">
                                                            <li><a href="http://GlobalScholar.us" alt="GlobalScholar.us" title="GlobalScholar.us" target="_blank">GlobalScholar.us</a>: The new Global Scholar Online Courses can help you get abroad and return to use your international learning to help you make a difference... for your education, your career and your future.</li>
                                                            <cfelseif sponsorswap is "3">
                                                            <li> <a href="http://allabroad.us" alt="AllAbroad.us" title="AllAbroad.us" target="_blank">AllAbroad.us</a>: A resource for students, parents, faculty, and administrators interested in study abroad. In it, you will find answers to common questions about study abroad given by our experienced mentors, including study abroad administrators, counselors, former study abroad students, and parents. </li>
                                                        </cfif>
                                                    </ul>
                                                </div>
                                                <div class="listing2">
                                                    <ul>
                                                        <cfif sponsorswap is "2">
                                                            <li><a href="http://GlobalScholar.us" alt="GlobalScholar.us" title="GlobalScholar.us" target="_blank">GlobalScholar.us</a>: The new Global Scholar Online Courses can help you get abroad and return to use your international learning to help you make a difference... for your education, your career and your future.</li>
                                                            <cfelseif sponsorswap is "1">
                                                            <li> <a href="http://allabroad.us" alt="AllAbroad.us" title="AllAbroad.us" target="_blank">AllAbroad.us</a>: A resource for students, parents, faculty, and administrators interested in study abroad. In it, you will find answers to common questions about study abroad given by our experienced mentors, including study abroad administrators, counselors, former study abroad students, and parents. </li>
                                                            <cfelseif sponsorswap is "3">
                                                            <li><a href="http://studiesabroad.com/jordan" alt="ISA" title="ISA" target="_blank">International Studies Abroad (ISA)</a>: Experience the best study abroad programs in Europe, Asia, Africa, Central America and South America. International Studies Abroad is here to help you gain that experience.</li>
                                                        </cfif>
...
' />
                ...
                <div id="right_content">
                    ...
                    <cfelseif myPcVar eq "Korea,South" or myPcVar eq "SouthKorea"
					or mypcVar eq "Korea%2CSouth"
					or mypcVar eq "KoreaSouth"
					or myPiVar eq "Seoul"
					or myPiVar eq "AnsungCity"
                    ...
                    or myPiVar eq "Glasgow" or myPiVar eq "St%2EAndrews"
                                ...
                                <div id="main_sponsors_featured_test">
                                    <cfif IsDefined("url.pc") or isDefined("url.pi")>
                                        ...
                                        <cfif myPcVar eq "Argentina"
                                            ...
                                            <cfset s1LogoMed = "no" />
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/argentina" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/argentina" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/argentina" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/argentina" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Australia"
                                            or myPiVar eq "Adelaide"
                                            or myPiVar eq "Albury-Wodonga"
                                            ...
                                            <cfset s2LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://www.globalinksabroad.org/" alt="GlobaLinksAbroad.com" title="GlobaLinksAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/GlobalLinks-logo-xl.jpg" alt="GlobaLinksAbroad.com" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://www.globalinksabroad.org/" alt="GlobaLinksAbroad.com" title="GlobaLinksAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/GlobalLinks-logo-lg.jpg" alt="GlobaLinksAbroad.com" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://www.globalinksabroad.org/" alt="GlobaLinksAbroad.com" title="GlobaLinksAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/GlobalLinks-logo-md.jpg" alt="GlobaLinksAbroad.com" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://www.globalinksabroad.org/" alt="GlobaLinksAbroad.com" title="GlobaLinksAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/GlobalLinks-logo-sm.jpg" alt="GlobaLinksAbroad.com" /></a>
                                            </cfif>
                                            <cfif s2LogoFull eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-xl.jpg" alt="StudyAbroad.com" /></a>
                                                <cfelseif s2LogoLg eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-lg.jpg" alt="StudyAbroad.com" /></a>
                                                <cfelseif s2LogoMed eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-md.jpg" alt="StudyAbroad.com" /></a>
                                                <cfelseif s2LogoSm eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-sm.jpg" alt="StudyAbroad.com" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Austria"
                                            or myPiVar eq "Braunau"
                                            or myPiVar eq "Bregenz"
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/belgium" alt="ISA" title="ISA"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/belgium" alt="ISA" title="ISA"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/belgium" alt="ISA" title="ISA"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/belgium" alt="ISA" title="ISA"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Botswana" or myPiVar eq "Gaborone" or myPiVar eq "Maun">
                                            <cfset s1LogoFull = "no" />
                                            <cfset s1LogoLg = "no" />
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC" target="_blank"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-xl.jpg" alt="CONAHEC" /></a>
                                                <cfelseif s1LogoFull eq "yes">
                                                <a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC" target="_blank"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-lg.jpg" alt="CONAHEC" /></a>
                                                <cfelseif s1LogoFull eq "yes">
                                                <a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC" target="_blank"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-md.jpg" alt="CONAHEC" /></a>
                                                <cfelseif s1LogoFull eq "yes">
                                                <a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC" target="_blank"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-sm.jpg" alt="CONAHEC" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Chile"
                                            or myPiVar eq "Antofagasta"
                                            or myPiVar eq "Arica"
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/chile" alt="International Studies Abroad" title="International Studies Abroad" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg"/></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/chile" alt="International Studies Abroad" title="International Studies Abroad" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg"/></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/chile" alt="International Studies Abroad" title="International Studies Abroad" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg"/></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/chile" alt="International Studies Abroad" title="International Studies Abroad" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg"/></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "China"
                                            or myPiVar eq "Baotou"
                                            or myPiVar eq "Beijing"
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/costa_rica" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/costa_rica" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/costa_rica" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/costa_rica" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "CzechRepublic" 
                                            or myPiVar eq "Brno" 
                                            or myPiVar eq "Olomouc" 
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/czech_republic" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/czech_republic" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/czech_republic" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/czech_republic" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Denmark" 
                                            or myPiVar eq "Aalborg" 
                                            or myPiVar eq "Aarhus" 
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://www.dis.dk/" alt="Danish Institute for Study Abroad" title="Danish Institute for Study Abroad" target="_blank"><img src="http://studentsabroad.com/images/logo/Danish-Institute-for-Study-Abroad-logo-xl.jpg" alt="Danish Institute for Study Abroad" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://www.dis.dk/" alt="Danish Institute for Study Abroad" title="Danish Institute for Study Abroad" target="_blank"><img src="http://studentsabroad.com/images/logo/Danish-Institute-for-Study-Abroad-logo-lg.jpg" alt="Danish Institute for Study Abroad" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://www.dis.dk/" alt="Danish Institute for Study Abroad" title="Danish Institute for Study Abroad" target="_blank"><img src="http://studentsabroad.com/images/logo/Danish-Institute-for-Study-Abroad-logo-md.jpg" alt="Danish Institute for Study Abroad" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://www.dis.dk/" alt="Danish Institute for Study Abroad" title="Danish Institute for Study Abroad" target="_blank"><img src="http://studentsabroad.com/images/logo/Danish-Institute-for-Study-Abroad-logo-sm.jpg" alt="Danish Institute for Study Abroad" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "DominicanRepublic" 
                                            or myPiVar eq "Jarabacoa" 
                                            or myPiVar eq "LaRomana" 
                                            ...
                                            <cfset s3LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://www.iaufrance.org/" title="Institute for American Universities" target="_blank"><img src="http://studentsabroad.com/images/logo/Institute-for-American-Universities-logo-xl.jpg" alt="Institute for American Universities logo" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://www.iaufrance.org/" title="Institute for American Universities" target="_blank"><img src="http://studentsabroad.com/images/logo/Institute-for-American-Universities-logo-lg.jpg" alt="Institute for American Universities logo" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://www.iaufrance.org/" title="Institute for American Universities" target="_blank"><img src="http://studentsabroad.com/images/logo/Institute-for-American-Universities-logo-md.jpg" alt="Institute for American Universities logo" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://www.iaufrance.org/" title="Institute for American Universities" target="_blank"><img src="http://studentsabroad.com/images/logo/Institute-for-American-Universities-logo-sm.jpg" alt="Institute for American Universities logo" /></a>
                                            </cfif>
                                            <cfif s2LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/france" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s2LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/france" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s2LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/france" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s2LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/france" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfif s3LogoFull eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-xl.jpg" alt="StudyAbroad.com" /></a>
                                                <cfelseif s3LogoLg eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-lg.jpg" alt="StudyAbroad.com" /></a>
                                                <cfelseif s3LogoMed eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-md.jpg" alt="StudyAbroad.com" /></a>
                                                <cfelseif s3LogoSm eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-sm.jpg" alt="StudyAbroad.com" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Germany"
                                            or myPiVar eq "Aachen"
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://www.CIEE.org" alt="CIEE" title="CIEE"><img src="http://studentsabroad.com/images/logo/CIEE-logo-xl.jpg"/></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://www.CIEE.org" alt="CIEE" title="CIEE"><img src="http://studentsabroad.com/images/logo/CIEE-logo-lg.jpg"/></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://www.CIEE.org" alt="CIEE" title="CIEE"><img src="http://studentsabroad.com/images/logo/CIEE-logo-md.jpg"/></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://www.CIEE.org" alt="CIEE" title="CIEE"><img src="http://studentsabroad.com/images/logo/CIEE-logo-sm.jpg"/></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Italy"
                                            or myPiVar eq "Milan"
                                            or myPiVar eq "Rome" or myPiVar eq "Florence"
                                            ...
                                            <cfset s2LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/italy" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/italy" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/italy" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/italy" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfif s2LogoFull eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-xl.jpg" alt="StudyAbroad.com" /></a>
                                                <cfelseif s2LogoLg eq "yes">
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/jordan" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/jordan" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/jordan" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/jordan" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "KenyaCoastRepublic"
                                            or myPcVar eq "Kenya Coast Republic"
                                            or myPcVar eq "Kenya%20Coast%20Republic"
                                            ...
                                            <cfif s2LogoFull eq "yes">
                                                <a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-xl.jpg"/></a>
                                                <cfelseif s2LogoLg eq "yes">
                                                <a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-lg.jpg"/></a>
                                                <cfelseif s2LogoMed eq "yes">
                                                <a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-md.jpg"/></a>
                                                <cfelseif s2LogoSm eq "yes">
                                                <a href="http://www.conahec.org" alt="CONAHEC" title="CONAHEC"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-sm.jpg"/></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Morocco" 
                                            or myPiVar eq "Casablanca" 
                                            or myPiVar eq "Fez" 
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/morocco" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/morocco" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/morocco" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/morocco" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Netherlands"
                                            or myPiVar eq "Amsterdam"
                                            or myPiVar eq "Delft"
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/peru" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/peru" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/peru" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/peru" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Poland" 
                                            or myPiVar eq "Krakow" 
                                            or myPiVar eq "Poznan"
                                            ...
                                            <cfset s1LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/<cfoutput>#myPcVar#</cfoutput>" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/<cfoutput>#myPcVar#</cfoutput>" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/<cfoutput>#myPcVar#</cfoutput>" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/<cfoutput>#myPcVar#</cfoutput>" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Sweden"
                                            or myPiVar eq "Alnarp" 
                                            or myPiVar eq "Karlstad"
                                            ...
                                            <cfset s2LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://studiesabroad.com/england" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://studiesabroad.com/england" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://studiesabroad.com/england" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://studiesabroad.com/england" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                            </cfif>
                                            <cfif s2LogoFull eq "yes">
                                                <a href="http://studyabroad.com" alt="StudyAbroad.com" title="StudyAbroad.com" target="_blank"><img src="http://studentsabroad.com/images/logo/StudyAbroad-logo-xl.jpg" alt="StudyAbroad.com" /></a>
                                                <cfelseif s2LogoLg eq "yes">
                                            ...
                                            <cfset s2LogoSm = "yes" />
                                            <cfif s1LogoFull eq "yes">
                                                <a href="http://uStudy.us/" alt="uStudy.us" title="uStudy.us" target="_blank"><img src="http://studentsabroad.com/images/logo/uStudy-logo-xl.jpg" alt="uStudy.us" /></a>
                                                <cfelseif s1LogoLg eq "yes">
                                                <a href="http://uStudy.us/" alt="uStudy.us" title="uStudy.us" target="_blank"><img src="http://studentsabroad.com/images/logo/uStudy-logo-lg.jpg" alt="uStudy.us" /></a>
                                                <cfelseif s1LogoMed eq "yes">
                                                <a href="http://uStudy.us/" alt="uStudy.us" title="uStudy.us" target="_blank"><img src="http://studentsabroad.com/images/logo/uStudy-logo-md.jpg" alt="uStudy.us" /></a>
                                                <cfelseif s1LogoSm eq "yes">
                                                <a href="http://uStudy.us/" alt="uStudy.us" title="uStudy.us" target="_blank"><img src="http://studentsabroad.com/images/logo/uStudy-logo-sm.jpg" alt="uStudy.us" /></a>
                                            </cfif>
                                            <cfif s2LogoFull eq "yes">
                                                <a href="http://globaled.us/PLUS/" alt="PLUS: The Project for Learning in the United States" title="PLUS: The Project for Learning in the United States" target="_blank"><img src="http://studentsabroad.com/images/logo/PLUS-logo-xl.jpg" alt="PLUS: The Project for Learning in the United States" /></a>
                                                <cfelseif s2LogoLg eq "yes">
                                                <a href="http://globaled.us/PLUS/" alt="PLUS: The Project for Learning in the United States" title="PLUS: The Project for Learning in the United States" target="_blank"><img src="http://studentsabroad.com/images/logo/PLUS-logo-lg.jpg" alt="PLUS: The Project for Learning in the United States" /></a>
                                                <cfelseif s2LogoMed eq "yes">
                                                <a href="http://globaled.us/PLUS/" alt="PLUS: The Project for Learning in the United States" title="PLUS: The Project for Learning in the United States" target="_blank"><img src="http://studentsabroad.com/images/logo/PLUS-logo-md.jpg" alt="PLUS: The Project for Learning in the United States" /></a>
                                                <cfelseif s2LogoSm eq "yes">
                                                <a href="http://globaled.us/PLUS/" alt="PLUS: The Project for Learning in the United States" title="PLUS: The Project for Learning in the United States" target="_blank"><img src="http://studentsabroad.com/images/logo/PLUS-logo-sm.jpg" alt="PLUS: The Project for Learning in the United States" /></a>
                                            </cfif>
                                            <cfelseif myPcVar eq "Vietnam"
                                            or myPiVar eq "AnGiang"
                                            or myPiVar eq "CanTho"
                                            ...
                                            <cfelse>
                                            <div id="main_sponsors_featured1">
                                                ...
                                                <cfset s4LogoSm = "yes" />
                                                <cfif s1LogoFull eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                    <cfelseif s1LogoLg eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                    <cfelseif s1LogoMed eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                    <cfelseif s1LogoSm eq "yes">
                                                    <cfif imageswap is "1">
                                                        <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                                        <cfelseif imageswap is "2">
                                                        <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/CIEE-logo-sm.jpg" alt="CIEE" /></a>
                                                        <cfelseif imageswap is "3">
                                                        <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-sm.jpg" alt="CONAHEC" /></a>
                                                        <cfelseif imageswap is "4">
                                                        <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/GlobalLinks-logo-sm.jpg" alt="GlobalLinks" /></a>
                                                    </cfif>
                                                </cfif>
                                            </div>
                                            <div id="main_sponsors_featured2">
                                                <cfif s2LogoFull eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                    <cfelseif s2LogoLg eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                    ...
                                                    <cfif imageswap is "3">
                                                        ...
                                                        <cfelseif imageswap is "2">
                                                        <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/CONAHEC-logo-sm.jpg" alt="CONAHEC" /></a>
                                                        <cfelseif imageswap is "1">
                                                        <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/GlobalLinks-logo-sm.jpg" alt="GlobalLinks" /></a>
                                                    </cfif>
                                                </cfif>
                                            </div>
                                            <div id="main_sponsors_featured3">
                                                <cfif s3LogoFull eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                    <cfelseif s3LogoLg eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                            ...
                                            <div id="main_sponsors_featured4">
                                                <cfif s4LogoFull eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-xl.jpg" alt="ISA" /></a>
                                                    <cfelseif s4LogoLg eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-lg.jpg" alt="ISA" /></a>
                                                    <cfelseif s4LogoMed eq "yes">
                                                    <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-md.jpg" alt="ISA" /></a>
                                                    <cfelseif s4LogoSm eq "yes">
                                                    <cfif imageswap is "3">
                                                        <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/ISA-logo-sm.jpg" alt="ISA" /></a>
                                                        <cfelseif imageswap is "4">
                                                        <a href="http://studiesabroad.com" alt="ISA" title="ISA" target="_blank"><img src="http://studentsabroad.com/images/logo/CIEE-logo-sm.jpg" alt="CIEE" /></a>
                                    ...
                                    <div id="sponsors_list">
                                        <div>
                                            <cfif IsDefined("url.pc") or isDefined("url.pi")>
                                                ...
                                                or myPiVar eq "Victoria">
                                                    <ul>
                                                        <li> <a href="http://www.terradotta.com/" title="Terra Dotta" target="_blank">Terra Dotta</a>
                                                        <li>
                                                        <li> <a href="http://www.internationalsos.com/en/" title="International SOS" target="_blank">International SOS</a> </li>
                                                        <li> <a href="http://www.hthworldwide.com/" title="HTH Worldwide">HTH Worldwide</a> </li>
                                                    </ul>
                                                    <cfelseif myPcVar eq "Australia"
                                                    or myPiVar eq "Adelaide"
                                                    or myPiVar eq "Albury-Wodonga"
                                                    ...
                                                    or myPiVar eq "Wollongong">
                                                    <ul>
                                                        <li> <a href="http://www.ciee.org/" title="CIEE">CIEE</a>
                                                        <li> <a href="http://www.hthworldwide.com/" title="HTH Worldwide">HTH Worldwide</a> </li>
                                                        <li> <a href="http://www.internationalsos.com/en/" title="International SOS" target="_blank">International SOS</a> </li>
                                                        <li> <a href="http://www.isic.org/" title="ISIC" target="_blank">ISIC</a>/<a href="http://www.statravel.com/" title="STA Travel" target="_blank">STA Travel</a> </li>
                                                    </ul>
                                                    <cfelseif myPcVar eq "Austria"
                                                    or myPiVar eq "Braunau"
                                                    or myPiVar eq "Bregenz"
...
or myPiVar eq "Magee">
                                                    ...
                                                    <div>
                                                        <ul>
                                                            <li> <a href="http://www.ciee.org/"  title="CIEE" target="_blank">CIEE</a> </li>
                                                            <li> <a href="http://www.hthworldwide.com/" title="HTH Worldwide">HTH Worldwide</a> </li>
                                                            <li> <a href="http://www.internationalsos.com/en/" title="International SOS" target="_blank">International SOS</a> </li>
                                                            <li> <a href="http://www.ciee.org/"  title="CIEE" target="_blank">CIEE</a> </li>
                                                            <li> <a href="http://www.hthworldwide.com/" title="HTH Worldwide">HTH Worldwide</a> </li>
                            ...
                            <div class="student_handbook_menu">
                                <cfif IsDefined("url.pc") or isDefined("url.pi")>
                                    ...
                                    <ul class="student_handbook_container">
                                        ...
                                        <li class="menu">
                                            <ul>
                                                <li class="button"> <a href="#" class="dropdown_button">Health and Security
                                                    <span>
                                                    </span>
                                                    </a> </li>
                                                <li class="dropdown">
