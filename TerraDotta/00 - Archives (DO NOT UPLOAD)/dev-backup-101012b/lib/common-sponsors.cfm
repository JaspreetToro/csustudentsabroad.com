...
<cfset sponsor.ISA.gen.title = "ISA" />
...
<cfset sponsor.ISA.gen.logo_med = "no" />
...
<!-- /* ISA Argentina/ ISA_ar*/ -->
<cfset ISA.ar = structNew() />

<cfset sponsor.ISA.ar.title = "ISA" />
...
<cfset sponsor.ISA.be.title = "ISA" />
...
<cfset sponsor.ISA.br.title = "ISA" />
...
<cfset sponsor.ISA.br.description = "...<a href=""http://studiesabroad.com/brazil/"">click here to learn more</a>" />
 ...
 <!-- /* ISA Dominican Republic/ ISA_do*/ -->
<cfset ISA.do = structNew() />
<cfset sponsor.ISA.do.title = "ISA" />
...
<cfset sponsor.ISA.do.description = "...<a href=""http://studiesabroad.com/http://studiesabroad.com/dominican_republic"">click here to learn more</a>" />
 ...
 <!-- /* ISA France/ ISA_fr*/ -->
<cfset ISA.do = structNew() />
<cfset sponsor.ISA.fr.title = "ISA" />
...
<cfset sponsor.ISA.fr.title_desc = "ISA in Paris, France" />
...
<cfset sponsor.ISA.cl.title = "ISA" />
...
<cfset sponsor.ISA.ch.title = "ISA" />
...
<cfset sponsor.ISA.ch.description = "...<a href=""http://www.studiesabroad.com/china"">click here to learn more</a>" />
 ...
 <!-- /* ISA Costa Rica/ ISA_cr*/ --> 
<cfset ISA.cr = structNew() /> 
<cfset sponsor.ISA.cr.title = "ISA" />
...
<cfset sponsor.ISA.cr.description = "Costa Rica is the ideal destination for students interested in the outdoors—from climbing trails to diving underwater to study ecology. The Spanish spoken in Costa Rica also provides a great opportunity for practicing and learning for students interested in pursuing language studies. ISA study abroad students have the opportunity to study at the Universidad Latina &mdash; Heredia, Universidad Latina &mdash; San Pedro, or Veritas University...<a href=""http://www.studiesabroad.com/costa_rica"">click here to learn more</a>" />
 ...
 <!-- /* ISA Czech Republic/ ISA_cz*/ --> 
<cfset ISA.cz = structNew() /> 
<cfset sponsor.ISA.cz.title = "ISA" />
...
<cfset sponsor.ISA.in.title = "ISA" />
...
<cfset sponsor.ISA.ie.title = "ISA" />
...
<cfset sponsor.ISA.it.title = "ISA" />
...
<cfset sponsor.ISA.jo.title = "ISA" />
...
<cfset sponsor.ISA.jo.description = "Located centrally in the Middle East, Jordan is the perfect spot to learn Arabic and travel around nearby Arab countries. It is host to the historic site of Petra and the Dead Sea, allowing a unique opportunity for students interested in studying architecture or ecosystems to learn more. Jordan’s religious sites and historical architecture from the Roman Empire add to its appeal.  Learn more about the ISA program in the capital city of Amman...<a href=""http://www.studiesabroad.com/jordan"">click here to learn more</a>" />
 ...
 <!-- /* ISA South Korea/ ISA_kr*/ -->
<cfset ISA.kr = structNew() />  
<cfset sponsor.ISA.kr.title = "ISA" />
...
<cfset sponsor.ISA.ma.title = "ISA" />
...
<cfset sponsor.ISA.es.title = "ISA" />
...
<cfset sponsor.ISA.pe.title = "ISA" />
...
<cfset sponsor.ISA.uk.title = "ISA" />
...
<cfset sponsor.TerraDotta.gen.description = "test description" />

 <!-- /* Globalinks General/ Globalinks*/ -->
...
<cfset sponsor.Globalinks.gen.logo_sm = "yes" />
<cfset sponsor.Globalinks.gen.title_desc = "Globalinks Learning Abroad" />
<cfset sponsor.Globalinks.gen.description = "test description" />

 <!-- /* Globalinks Australia/ Globalinks*/ -->
<cfset Globalinks.au = structNew() /> 
<cfset sponsor.Globalinks.au.title = "Globalinks Learning Abroad" />
<cfset sponsor.Globalinks.au.url = "http://www.goabroad.com/providers/globalinks-learning-abroad/programs##4" />
<cfset sponsor.Globalinks.au.logo = "http://studentsabroad.com/images/logo/GlobalLinks-logo.jpg" />
<cfset sponsor.Globalinks.au.logo_s = "http://studentsabroad.com/images/sponsors/logo/GlobalLinks-logo-sm.gif" />
<cfset sponsor.Globalinks.au.logo_m = "http://studentsabroad.com/images/sponsors/logo/GlobalLinks-logo-md.gif" />
<cfset sponsor.Globalinks.au.logo_l = "http://studentsabroad.com/images/sponsors/logo/GlobalLinks-logo-lg.gif" />
<cfset sponsor.Globalinks.au.logo_xl = "http://studentsabroad.com/images/sponsors/logo/GlobalLinks-logo-xl.gif" />
<cfset sponsor.Globalinks.au.banner_1 = "" />
<cfset sponsor.Globalinks.au.logo_ls = "http://studentsabroad.com/images/sponsors/logo/GlobalLinks-logo-ls.gif" />
...
<cfset sponsor.CONAHEC.gen.title = "CONAHEC" />
...
<cfset sponsor.PLUS.gen.title = "PLUS" />
...
<cfset sponsor.PLUS.gen.description = "test description" />
...
<cfset sponsor.CIEE.gen.description = "test description" />
...
<cfset sponsor.IAU.gen.title = "Institute for American Universities" />
...
<cfset sponsor.IAU.gen.title_desc = "Institute for American Universities" />
...
<cfset sponsor.CEA.gen.description = "...<a href=""http://www.gowithcea.com/"">click here to learn more</a>" />
 ...
 <!-- /* DIA/ Danish Institute for Abroad */ -->
...
<cfset sponsor.HTH.gen.description = "test description" />
...
<cfset sponsor.ISOS.gen.description = "test description" />
...
<cfset sponsor.ISIC.gen.description = "test description" />
...
<cfset sponsor.STA.gen.description = "test description" />

 <!-- /* AllAbroad.us */ -->
<cfset STA.gen = structNew() /> 
<cfset sponsor.STA.gen.title = "AllAbroad.us" />
<cfset sponsor.STA.gen.url = "http://allabroad.us" />
<cfset sponsor.STA.gen.logo = "http://studentsabroad.com/images/logo/AllAbroad-logo.jpg" />
<cfset sponsor.STA.gen.logo_s = "http://studentsabroad.com/images/sponsors/logo/AllAbroad-logo-sm.gif" />
<cfset sponsor.STA.gen.logo_m = "http://studentsabroad.com/images/sponsors/logo/AllAbroad-logo-md.gif" />
<cfset sponsor.STA.gen.logo_l = "http://studentsabroad.com/images/sponsors/logo/AllAbroad-logo-lg.gif" />
<cfset sponsor.STA.gen.logo_xl = "http://studentsabroad.com/images/sponsors/logo/AllAbroad-logo-xl.gif" />
<cfset sponsor.STA.gen.banner_1 = "" />
<cfset sponsor.STA.gen.logo_ls = "http://studentsabroad.com/images/sponsors/logo/AllAbroad-logo-ls.gif" />
<cfset sponsor.STA.gen.logo_lead_sponsor = "no" />
<cfset sponsor.STA.gen.logo_change = "no" />
<cfset sponsor.STA.gen.logo_full = "no" />
<cfset sponsor.STA.gen.logo_lg = "no" />
