	...
	<div id="maincontainer_footer">
        ...
        <div class="middle_footer">
        	<div class="footer_about">
            	<div class="footer_logo"><img src="images/logo.jpg" width="182px" height="41px" /></div>
            	<div class="footer_brief"><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p></div>
            </div>
            ...
            <div class="footer_resources">
            	...
            	<div class="footer_brief">
            		<ul>
                    	<li>Statements on Internationalization</li>
                        <li>Global Dialogue</li>
                    </ul>
            	</div>    	    
            </div>
            <div class="footer_get_involved">
            	<div class="footer_title">Get Involved</div>
            	<div class="footer_brief">
            		<ul>
                    	<li>Overview</li>
                        <li>Support</li>
                        <li>Degree Training</li>
                        <li>Research</li>
                    </ul>
            	</div>  
            </div>
        </div>
        <div class="bottom_footer">&copy; Copyright 2014. Center for Global Education. All Rights Reserved. Terms of Use | Contact CGE | Support CGE</div>
    </div>
</div>
        ...
        <div class="statements_wrapper">
            ...
            <div class="content">
                ...
                <div class="sub_feature1">
                    ...
                    <div class="sub_feature_more"><span class="en"><a href="global-dialogue.php">Read More&nbsp;<img src="images/arrow_blue.gif"></a></span></div>
                </div>
            </div>
        </div>
    </div>
