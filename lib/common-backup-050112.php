...
define("URLNAME", "Studentsabroad.us/");
    ...
    <div id="maincontainer_top">
        <div id="header">
            <div id="left_header">
                ...
                <div id="left_header_logo"><a href="<?=URLNAME?>"><img src="images/studentsabroad-logo.jpg" /></a></div>
                <script language="javascript">renderDiv(10);</script>
                <div id="left_header_menu" >
                    <div id="glowingtabs">
                        <ul>
                            <li id="<?=$id1?>"><a href="index.php" title="Home: Welcome to StudenstAbroad.com" id="home_link"><span>
                                <div class="padding13">Home</div>
                                <div class="menu_subtitle">The Main Page</div>
                                </span></a></li>
                            <li id="<?=$id2?>"><a href="http://studentsabroad-dev.terradotta.com/index.cfm?FuseAction=Programs.SimpleSearch" title="Program Search: Discover Your Options" id="why_us_subnav_link"><span>
                                <div class="padding13">Program Search</div>
                                <div class="menu_subtitle">Discover Your Options</div>
                                </span></a></li>
                            <li id="<?=$id3?>"><a href="handbook/introduction.php?country=General" title="Student Handbooks: How to Get There and Back" id="apply_subnav_link"><span>
                                <div class="padding13">Student Handbooks</div>
                                <div class="menu_subtitle">How to Get There and Back</div>
                                </span></a></li>
                            <li id="<?=$id4?>"><a href="featured-programs.php" title="Featured Programs: Options Around the World" id="finance_subnav_link"><span>
                    ...
                    <div id="apply_subnav" class="subnav_noshow" onmouseover="showsubnav('apply_subnav');" onmouseout="hidesubnav('apply_subnav');">
                        ...
                        <div class="inner_subnav_apply_subnav">
                            <ul class="list_mainsubnav">
                                ...
                                <li class="list_mainsubnav_item"> <span class="medium_white"><img src="../images/arrow_white.gif" />&nbsp; Location</span>
                                ...
                                <li class="list_mainsubnav_item"> <span class="medium_white"><img src="../images/arrow_white.gif" />&nbsp; Campus Life</span>
                                    <ul class="list_3rdlevel">
                                ...
                                <li class="list_mainsubnav_item"> <span class="medium_white"><img src="../images/arrow_white.gif" />&nbsp; Academics</span>
                                    <ul class="list_3rdlevel">
                                ...
                                <li class="list_mainsubnav_item"> <A href="apply_interview.php" class="<?php if($_SERVER['PHP_SELF'] == "/apply_interview.php") echo "medium_dark_blue_bold"; else  echo "medium_white"; ?>"><img src="../images/arrow_white.gif" />&nbsp; Video: Applying</A> </li>
                            </ul>
                        </div>
                    ...
                    <div id="why_us_subnav" class="subnav_noshow" onmouseover="showsubnav('why_us_subnav');" onmouseout="hidesubnav('why_us_subnav');">
                        ...
                        <div class="inner_subnav_why_us_subnav">
                            <ul class="list_mainsubnav">
                                ...
                                <li class="list_mainsubnav_item"> <span class="medium_white"><img src="../images/arrow_white.gif" />&nbsp; Language</span>
                                    <ul class="list_3rdlevel">
                    ...
                    <div id="finance_subnav" class="subnav_noshow" onmouseover="showsubnav('finance_subnav');" onmouseout="hidesubnav('finance_subnav');">
                        ...
                        <div class="inner_subnav_finance_subnav">
                            <ul class="list_mainsubnav">
                                ...
                                <li class="list_mainsubnav_item"> <span class="medium_white"><img src="../images/arrow_white.gif" />&nbsp; Working on Campus</span>
                                    <ul class="list_3rdlevel">
                    ...
                    <div id="resource_subnav" class="subnav_noshow" onmouseover="showsubnav('resource_subnav');" onmouseout="hidesubnav('resource_subnav');">
                        ...
                        <div class="inner_subnav_resource_subnav">
                            <ul class="list_mainsubnav">
                                <li class="list_mainsubnav_item"> <span class="medium_white"><img src="../images/arrow_white.gif" />&nbsp; Getting into the country</span>
                                    <ul class="list_3rdlevel">
                                ...
                                <li class="list_mainsubnav_item"> <span class="medium_white"><img src="../images/arrow_white.gif" />&nbsp; Maintaining your health</span>
                                    <ul class="list_3rdlevel">
            ...
            <div id="right_header">
                ...
                <div id="right_header_center_logo"><img src="images/cge-logo.jpg" /></div>
                <script language="javascript">renderDiv(37);</script>
                <div id="right_header_bottom">
                    <div id="community_tab">
                        <div id="glowingtabs_orange">
                            <ul>
                                <li><a href="about_us.php" title="About Us" target="_blank"><span>
                                    <div class="padding13">About Us</div>
                                    </span></a></li>
                                <li><a href="contact_us.php" title="Contact Us" target="_blank"><span>
            ...
            <div class="contentdiv_inside">
                ...
                <div class="content_text">
                    <div class="content_text_top">
                        <script language="javascript">renderDiv(7);</script>
                    ...
                    <div class="content_text_middle">
                        ...
                        <div class="padding7">Learn about which U.S. city is the best fit for you
                            <script language="javascript">renderDiv(20);</script>
                            <a href="city_detail.php" class="big_white_bold">&gt; City Intro</a></div>
                    </div>
...
<form action="<?=append_sid('forum/ucp.php?mode=login')?>" method="post" id="login">
    <table cellpadding="1" cellspacing="0" border="0" class="small_dark_grey_bold" width="100%">
        ...
        <TR>
            <TD>
                <input type="text" name="username" id="username" size="25" class="small_dark_grey" maxlength="20" />
            </TD>
        ...
        <TR>
            <TD>
                <input id="password" name="password" size="25" class="small_dark_grey" type="password" />
            </TD>
...
<div style="padding: 0 0 0 3px;">
    <form action="<?=append_sid('forum/ucp.php?mode=login')?>" method="post" id="login">
        <table cellpadding="1" cellspacing="0" border="0" class="small_dark_grey_bold" width="100%">
            ...
            <TR>
                <TD>
                    <input type="text" name="username" id="username" class="small_dark_grey" size="15" maxlength="20" />
                </TD>
            </TR>
            <TR>
                <TD>Password:</TD>
            ...
            <TR>
                <TD>
                    <input id="password" name="password" size="15" class="small_dark_grey" type="password" />
                </TD>
            </TR>
            <TR>
                <TD>
            ...
            <TR>
                <TD align="center">
                    <script language="javascript">renderDiv(5);</script>
                    <img src="images/button_login.jpg" onclick="document.getElementById('login').submit();" class="pointer" /></TD>
            </TR>
            <TR>
                <TD align="center">
                    <script language="javascript">renderDiv(5);</script>
                    <a href="forum/ucp.php?mode=register"><img src="images/button_register.jpg" class="pointer"  /></a></TD>
            </TR>
        </table>
    </form>
</div>
...
<div>
    ...
    <div id="list_city">
        ...
        <div class="list_city_middle">
            <script language="javascript">renderDiv(4);</script>
            <a href="#" class="small_white">
            <?=$city['city']?>
            </a></div>
        <?php
										}
...
<div>
    ...
    <div id="featured_story">
        <div id="featured_story_top">
            <script language="javascript">renderDiv(8);</script>
            <div id="featured_story_top_content" ><img src="images/arrow_blue.gif" />&nbsp;<a href="story_detail.php" class="small_dark_blue_bold">Featured Story:</a>&nbsp;<a href="story_detail.php?story_id=<?=$story_list[$featured_index]['story_id']?>" class="small_white_bold">
                <?=$story_list[$featured_index]['title']?>
                </a></div>
        </div>
    ...
    <div id="list_story">
        ...
        <div class="list_city_middle">
            <script language="javascript">renderDiv(4);</script>
            <a href="story_detail.php?story_id=<?=$story['story_id']?>" class="small_white">
            <?=$story['title']?>
            </a></div>
        <?php
										}
