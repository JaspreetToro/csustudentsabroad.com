    ...
    <span class="new_subpage_left_container">
        <div id="new_subpage_left_container_top">
            <div id="left_content_top_upper">
                        ...
                        <div id="left_content_top_upper2">CSU SAN BERNARDINO
                        </div> 
                    </div>
            <div id="new_nonav_subpage_content" >
                ...
                <div>
                    ...
                    <div class="subpage_full_text">
                        <div id="subpage_text_title"><a href="https://www.csusb.edu/cisp/study-abroad">Study Abroad Support
                        </a></div></br>
                        <div id="subpage_text1"><p> The internationalization of CSU San Bernardino has been a collaboration between the Center of International Studies and Programs (CSIP), the university, and off-campus partners. As a result, their programs, activities, and services all support CSU San Bernardino’s goals. For example, a faculty-led program will give students an innovative learning experience that helps fulfill the mission of the university.</p>
                            <p>The College of Arts and Letters works with CSUSB's Center for International Studies and Programs to offer a variety of opportunities for students to study outside the United States. In short-term summer programs, students can develop foreign language skills, experience other cultures, explore cultural, historic, and artistic heritage sites, and gain valuable perspectives on American culture.</p>
                            <p>With short-term summer programs in England, France, Spain, Jordan, Korea, Japan, and Costa Rica, the department offers students a variety of possibilities for exploring the global community. Students will enjoy traveling with faculty, as professors teach classes and lead excursions around the host country.</p>
                        </div>
        ...
        <!-- end of subpage_left_container_top  -->
                    ...
                    <div id="subpage_image" style="background:url(../images/sanbernardino1.jpg);">
                    </div>
                    <!-- end of inage division-->
                    <div id="subpage_text2">
                        <p><div id="subpage_text_title"><a href="https://www.csusb.edu/">About CSU San Bernardino</a></div> </br>  
                            <div>CSU San Bernardino is a preeminent center of intellectual and cultural activity in Inland Southern California. Opened in 1965 and set at the foothills of the beautiful San Bernardino Mountains, the university serves more than 20,000 students each year and graduates about 4,000 students annually. The university offers more than 70 traditional baccalaureate and master's degree programs, education credential and certificate programs, and a doctoral program. In recent years, CSUSB added its first doctorate (educational leadership), engineering program (computer science and engineering) and M.F.A. programs in creative writing and studio/art design.</p>
                            </div>
                        
                    </div>
                    <!-- end text2 divsion-->
                    <div id="subpage_image" style="background:url(../images/sanbernardino2.jpg) ;">
                    </div>   
    </span>
