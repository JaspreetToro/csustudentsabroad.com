    ...
    <span class="new_subpage_left_container">
        <div id="new_subpage_left_container_top">
            <div id="left_content_top_upper">
                        ...
                        <div id="left_content_top_upper2">CAL MARITIME
                        </div> 
                    </div>
            <div id="new_nonav_subpage_content" >
                ...
                <div>
                    ...
                    <div class="subpage_full_text">
                        ...
                        <div id="subpage_text1"><p>International voyages are part of Cal Maritime's specialized, experiential-based curriculum that requires all cadets to travel abroad while taking courses and gaining important experiences for each major. These international experiences are one important way that Cal Maritime ensures each of its graduates obtains an international perspective that prepares them for success in today's global economy. Cal Maritime’s study-abroad opportunities are also available through partnerships with other maritime universities in their exchange program. The academy sponsors  faculty-led, three-week study tours to international locations providing students with valuable exposure to the business environment and political issues around the globe.</p>
                        </div>
        ...
        <!-- end of subpage_left_container_top  -->
                    ...
                    <div id="subpage_image" style="background:url(../images/maritime1.jpg);">
                    </div>
                    ...
                    <!-- end text2 divsion-->
                    <div id="subpage_image" style="background:url(../images/maritime2.jpg) ;">
                    </div>   
    </span>
