...
<body>
 <form method="post" action="#">
        ...
        <div class="box_right_form">
            ...
            <div class="box_advanced"><a href="simplesearch.php" class="small_dark_blue_bold">Simple Search</a></div>
        </div>
...
$qs = http_build_query($data);
       ...
       #  $html = file_get_contents('http://directory.studentsabroad.com/index.cfm?'.$qs.');
		 ...
		 $nhtml = substr($html,$posStart,$posLength);
		 echo $nhtml;
		 ?>
         </body>