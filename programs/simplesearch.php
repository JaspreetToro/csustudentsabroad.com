...
<div class="col-sm-2 sidenav text-left" style="position:relative;display:inline-block;">
      <p><a href="#">Link</a></p>
      <p><a href="#">Link</a></p>
      <p><a href="#">Link</a></p>
      <p><a href="#">Link</a></p>
...
$qs = http_build_query($data);
       ...
       #  $html = file_get_contents('http://directory.studentsabroad.com/index.cfm?'.$qs.');
		 ...
		 foreach ($rtable as $value) {
			...
			#$value = str_replace('index.cfm?','https://studyabroaddirectory.terradotta.com/index.cfm?',$value);
			
			$posStart = strpos($value, "Program_ID=")+11;
			
			
			$programID = substr($value, $posStart, 5);
			
			list($part1, $part2) = explode('Program_ID', $value);
			
			$nvalue = $part1 . 'onclick('.$programID.')' . 'Program_ID' . $part2;
