    ...
    <div class="highlight">
        <div class="student-handbook">
            <div class="title sh-gradient sh-corner-top">
            	    <div class="country"> <span class="flag"><img class="country-flag" width="51px" height="29px" alt="<?php echo $country_name?>" src="handbook/images/country-flag/<?php echo $country_name?>-flag.gif" /></span> &nbsp;<span class="label"><?php echo $country_name?></span> </div>
                    ...
                    <div id="content_container">
                        ...
                        <div id="emergency-card">
                            ...
                            <div class="emergency-card-form">
                                <form id="shEmergencyCardForm" name="shEmergencyCardForm" method="post" onsubmit="return validateForm('shEmergencyCardForm','getCard')" action="emergency-card-verification.php?country=<?php if ($country_name == "Worldwide") { echo "General"; } else { echo $country_name; } ?>">
                               	<div>
                                    ...
                                    <div>
                                        ...
                                        *
                                        ...
                                        <?php if ($embassy_consulate_tel_error != "") { echo '<div>'.$embassy_consulate_tel_error.'</div>'; } ?>
                                         <label for="embassy_consulate_mobile">Mobile</label>
                                        <input type="tel" id="embassy_consulate_mobile" name="embassy_consulate_mobile" <?php if (!empty($embassy_consulate_mobile)) { echo 'value="'.$embassy_consulate_mobile.'"'; } ?> placeholder="Embassy/consulate mobile"  maxlength="34" />
                                        <?php if ($embassy_consulate_mobile_error != "") { echo '<div>'.$embassy_consulate_mobile_error.'</div>'; } ?>
                                    ...
                                    <div class="sh_box_button">
                                        <input class="sh_button" type="submit" name="submit" id="nextButton" value="Next" title="Click next to review your information!" />
