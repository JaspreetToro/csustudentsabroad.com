        ...
        <div class="highlight">
            <div class="student-handbook">
                <div class="title sh-gradient sh-corner-top">
                        <div class="country"> <span class="flag"><img class="country-flag <?php echo $country_title?>-flag" width="51px" height="29px" alt="<?php echo $country_title?>" src="handbook/images/country-flag/<?php echo $country_title?>-flag.gif" /></span> &nbsp;<span class="label"><?php echo $country_title?></span> </div>
