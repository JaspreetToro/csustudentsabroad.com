...
function printBody() {
	...
	if ( isset($_POST['submit']) ){	
		...
		if( isset($_POST['submit']) && $special_code == "CenterGlobal10" ) {
                    ...
                    <div id="content_container">
                        ...
                        <div id="emergency-card">
                            ...
                            <div class="emergency-card-form">
                                <form id="shEmergencyCardForm" name="shEmergencyCardForm" method="post" onsubmit="return validateForm('shEmergencyCardForm','sendCard')" action="thank-you.php?country=<?php if ($country_name == "Worldwide") { echo "General"; } else { echo $country_name; } ?>">
                               	<div>
                                    ...
                                    <div class="sh_box_button">
                                        ...
                                        <input type="hidden" name="key" value="<?php echo $_SESSION['session_id'] ?>" />
                                    </div>                                    
                                </form>
                            </div>
                        </div>
