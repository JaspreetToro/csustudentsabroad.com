<?php
	...
	$pageTitle = "Emergency Action Plan Steps";
	/* 
	...
	try {
		...
		$emergencyActionPlanContent  = new Template("content/emergency-planning-steps-content.tpl");
		...
		/*$emergencyActionPlanContent->set("nationality", $country['nationality']);
		$emergencyActionPlanContent->set("nationality1", $country['nationality_with_article']);
		$emergencyActionPlanContent->set("countryPrimaryLanguage", $country['primary_language']);
		...
		$layout->set("title", "Emergency Action Plan Steps");
		$layout->set("header", "Emergency Action Plan Steps");
