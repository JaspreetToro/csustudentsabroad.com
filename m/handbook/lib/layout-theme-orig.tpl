        ...
        <div id="content">
            ...
            <div id="left_content_quicksearch_container">
                <div id="left_content_program_search">
                    <div id="box2_top" title="COUNTRY SPECIFIC HANDBOOKS">
            ...
            <div id="right_content">
                ...
                <div id="right_content_middle_sm">
                    <div id="box2_top_sm" title="COUNTRY SPECIFIC HANDBOOKS">
                        <span class="box_title">
                            <strong>COUNTRY SPECIFIC HANDBOOKS</strong>
                        </span>
                    ...
                    <div id="study_abroad_resources">
                        <div id="student_handbook_title_container">
                            <div id="student_handbook_title">Study Abroad <br />Student Handbook</div>
                        </div>
