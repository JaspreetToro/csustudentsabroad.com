...
<script language="JavaScript" type="text/javascript">
    ...
    var basicsearchcontent = '<div id="basicsearchcontainer"><div>DEMO: Simple Search</div><form name="frm" id="frm" enctype="multipart/form-data" action="results.php" method="get"><table width="218" border="1" rules="cols"><tr><th width="208" height="25" align="left" bgcolor="#CCCC99">Location / Term</th></tr><tr><td>Program Name <br /> {PROGRAM_NAME}</td></tr><tr><td align="left"  >City<br />{PROGRAM_CITY}</td></tr><tr><td align="left"  >Country<br />{PROGRAM_COUNTRY}</td></tr><tr><td align="left">Region<br />{PROGRAM_REGION}</td></tr><tr><td align="left">Term<br />{PROGRAM_TERMS}</td></tr ><tr><td align="center"><input type="button" name="button" id="button" value="-Search-" onclick="Search()" /></td></tr></table></form></div>';
