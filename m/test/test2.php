...
var basicsearchcontent= '<div id="basicsearchcontainer">&<form name="frm" id="frm" enctype="multipart/form-data" action="process.php"><table width="218" border="1" rules="cols"><tr><th width="208" height="25" align="left" bgcolor="#CCCC99">Search Our Programs:</th></tr><tr><td align="left"  >City<br />{PROGRAM_CITY}</td></tr><tr><td align="left"  >Country<br />{PROGRAM_COUNTRY}</td></tr><tr><td align="left">Region<br />{PROGRAM_REGION}</td></tr><tr><td align="left">Term<br />{PROGRAM_TERMS}</td></tr ><tr><td align="center"><input type="button" name="button" id="button" value="-Search-" onclick="Search()" /></td></tr></table></form></div>'  
