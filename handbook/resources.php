<?php
    ...
    try {
		...
		if ($country_name == "United States" || $country_name == "United Kingdom" || $country_name == "Czech Republic" || $country_name == "Dominican Republic") 		{
			$mainTemplate->set("country", "in the ".$country['country_name']); 
			$mainTemplate->set("countryPrimaryLanguage", $country['primary_language']);
        } else if($country_name == "General"){
			$mainTemplate->set("country", "abroad"); 
			$mainTemplate->set("countryPrimaryLanguage", "a specific language"); 
		} else {
			$mainTemplate->set("country", "in ".$country['country_name']); 
			$mainTemplate->set("countryPrimaryLanguage", $country['primary_language']);
		}
		
		/* Takes care of US Embassy URLs) */
		if ($country['country_name'] == "United States" || $country['country_name'] == "the country of your choice") {
		...
		} else if ($country['country_name'] == "Spain") {
			$mainTemplate->set("country_URLs", "madrid.usembassy.gov"); 	
		} else {
