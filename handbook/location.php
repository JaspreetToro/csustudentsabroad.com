<?php
	...
	try {
		...
		foreach ($links as $key => $value) {
            $row = new Template("content/handbook/introduction-links.tpl");
            if (preg_match("/3_a_text$/", $key) || preg_match("/4_a_text$/", $key)) {
		...
		$usersList  = new Template("content/handbook/introduction-content.tpl");
		$usersList->set("country", $country['country_name']);
		$usersList->set("linksToRemember", $usersContents);	
		...
		if ($country_name == "United States" || $country_name == "United Kingdom" || $country_name == "Czech Republic" || $country_name == "Dominican Republic") {
			...
			/*if($country_name == "United States") {
				layout->set("specialIssue", "<p><a href=\"http://globaled.us/safeti/special-issue-boston-marathon-tragic-events-and-international-student-support-in-the-us.asp\" class=\"dark_blue_bold\" target=\"_blank\">Special Issue: Tragic Events at Boston Marathon and Support for International Students at U.S. Colleges and Universities</a></p>";
			}*/
        }
