...
Information</a> page, the <a href=\"http://www.dfait-maeci.gc.ca/\">Canadian Department of Foreign Affairs and Trade</a>, and the <a href=\"http://www.fco.gov.uk/\">U.K. Foreign Commonwealth Office</a>."),   
    ...
    $introduction = array(
	 ...
	 /* Links to Remember */
    $introduction = array(
        array("title" => "Tools for Learning a Language Link (NY Times Article)", "URL" => "https://www.nytimes.com/2014/07/20/travel/inventive-cheaper-tools-for-learning-a-language.html"),
        array("title" => "Auburn University: 25 Reasons to Study a Foreign Language", "URL" => "http://cla.auburn.edu/forlang/resources/twenty-five-reasons/")
    );
	...
	$whoRunsYourProgram = array(
		...
		array("title" => "Sara&#39;s Wish", "URL" => "http://www.saraswish.org/travel-safety/evaluating-study-abroad-programs-for-health-and-safety-good-practices/")	
	);
