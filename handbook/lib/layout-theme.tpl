...
<title>CSU StudentsAbroad.com - Study Abroad Handbook [@country]: [@title]</title>
...
$(document).ready(function() {
	...
	$(".list_link_middle:last-child").addClass('last');
});
...
$(window).load(function () {	
	...
	$('#content_container h2:first').css('border-top', 'none');
	//$('#content_container h2').nextUntil('h2').hide();
	$('#content_container h2').click(function(){
