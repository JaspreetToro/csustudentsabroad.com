    ...
    <span class="new_subpage_left_container">
        <div id="new_subpage_left_container_top">
            <div id="left_content_top_upper">
                        ...
                        <div id="left_content_top_upper2">STANISLAUS STATE UNIVERSITY
                        </div> 
                    </div>
        ...
        <!-- end of subpage_left_container_top  -->
                    ...
                    <div id="subpage_image" style="background:url(../images/stanislaus1.jpg);">
                    </div>
                    ...
                    <!-- end text2 divsion-->
                    <div id="subpage_image" style="background:url(../images/stanislaus2.jpg) ;">
                    </div>   
    </span>
