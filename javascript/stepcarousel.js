...
var stepcarousel={
	...
	statusreport:function(galleryid){
		...
		if(startpoint == 1)
			document.getElementById('arrow_left').className = 'hidden';
		else
			document.getElementById('arrow_left').className = 'shown';
		
		if(startpoint == 5)
			document.getElementById('arrow_right').className = 'hidden';
		else
			document.getElementById('arrow_right').className = 'shown';
